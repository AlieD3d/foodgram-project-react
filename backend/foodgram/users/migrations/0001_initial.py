            ...
            fields=[
                ...
                ('is_superuser', models.BooleanField(
                    ...
                    help_text='Designates that this'
                              ' user has all permissions without '
                ...
                ('username', models.CharField(
                    help_text=(
                        'Обязательно для заполнения. От 3 до 150 букв.',),
                    max_length=150,
                    unique=True,
                    validators=[
                        users.validators.MinLenUsernameValidator(min_len=3),
                        users.validators.RegexpStringValidator()],
